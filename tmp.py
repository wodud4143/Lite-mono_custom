...
def parse_args():
    ...
    parser.add_argument('--population_size', type=int, default=40, help='Number of individuals in each generation for GA.')
    parser.add_argument('--num_generations', type=int, default=20, help='Number of generations to evolve for GA.')
