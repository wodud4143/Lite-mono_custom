...
def parse_args():
    ...
    parser.add_argument('--load_weights_folder', type=str,
                        ...
                        default=r'C:\Users\wodud\OneDrive\Desktop\Lite-mono_custom\experiments\logs\Ghost_CDC_Down_coord_100ep_pre\models\weights_95'
                        )
...
def test_simple(args):
    ...
    image_folder = r"C:\Users\wodud\OneDrive\Desktop\도로주행 데이터\Ghost_CDC_Down_coord_100ep_pre\2011_09_26_drive_0009_sync_학습함"
    if image_folder :
...
def direct():
    ...
    directory = r"C:\Users\wodud\OneDrive\Desktop\도로주행 데이터\Ghost_CDC_Down_coord_100ep_pre" 
